...
import com.recipeproject.recipeapp.converters.RecipeCommandToRecipe;
import com.recipeproject.recipeapp.converters.RecipeToRecipeCommand;
...
public class RecipeServiceImpl implements RecipeService {
    ...
    public Recipe findById(Long id){
        ...
        if(!recipeOptional.isPresent()){
            throw new RuntimeException("Recipe with such id is not found!");
        }
